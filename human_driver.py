...
def Simulation():
    ...
    while end_sim == False:
        ...
        wn.onkeypress(Driver.set_thrust_right, "d") # listen for key press
        wn.onkeypress(Driver.set_thrust_left, "a")  # listen for key press
        wn.onkeyrelease(Driver.reset_thrust,"d")
        wn.onkeyrelease(Driver.reset_thrust,"a")
...
class Pilot(object):
    def __init__(self):
        self.force = 0
    def set_thrust_right(self):
        #print("THRUST RIGHT")
        self.force = 10
    def set_thrust_left(self):
        #print("THRUST LEFT")
        self.force = -10
